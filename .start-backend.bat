...
set INFRA=--spring.redis.host=127.0.0.1 --spring.redis.port=6379 --spring.redis.password=amzpass --spring.data.redis.host=127.0.0.1 --spring.data.redis.port=6379 --spring.data.redis.password=amzpass --spring.rabbitmq.host=127.0.0.1
